...
<head>
  ...
  <link rel="stylesheet" href="assets-template/plugins/datatables-responsive/css/responsive.bootstrap.min.CSS">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <img src="assets-template/dist/img/pacepal.png" alt="PacePal Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Dashboard PACEPAL</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="assets-template/dist/img/pacepal.png" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($_SESSION['level'] != 'User') : ?>
              ...
              <li class="nav-item">
                <a href="daftar-pesanan-semua.php" class="nav-link">
                  <i class="nav-icon fas fa-newspaper"></i>
                  <p>
                    Data Pesanan
                  </p>
            ...
            <?php else : ?>
              <li class="nav-item">
                <a href="daftar-pesanan.php" class="nav-link">
                  <i class="nav-icon fas fa-newspaper"></i>
                  <p>
                    Data Pesanan
                  </p>
